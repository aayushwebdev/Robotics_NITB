...
const Social = () => {
  return (
    <div className={styles.social}>
        <a href="https://www.facebook.com/roboticsclubmanit/" target="_blank"><i class='bx bxl-facebook' ></i></a>
        <a href="https://twitter.com/manitbpl?lang=en" target="_blank"><i class='bx bxl-twitter' ></i></a>
